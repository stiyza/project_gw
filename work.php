            ...
            <div class="shadow rounded p-5 bg-body h-100">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <a href="work-create.php" class="btn btn-primary"  >เพิ่มคิวงาน</a>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="work-update.php?id=<?php echo $row['id'] ?>" class="btn btn-warning"> แก้ไข </a>
                                                <a href="php/workdelete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"> ลบ </a>
                                            </div>
                                        </td>
                                    </tr>
                                    <!-- Modal -->
